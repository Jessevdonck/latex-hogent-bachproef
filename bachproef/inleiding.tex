...
Om deze doelstelling te bereiken, worden in deze bachelorproef vier deelvragen uitgewerkt. Ten eerste wordt onderzocht hoe een XR-toepassing op Meta Quest 3 procedurele BLS- en AED-stappen kan ondersteunen binnen de didactische vereisten van de opleiding verpleegkunde. Ten tweede wordt bepaald welke minimale technische voorwaarden nodig zijn voor een stabiele en uitbreidbare XR-simulatieomgeving. Ten derde wordt nagegaan welke eerste indicaties over bruikbaarheid en didactische inzetbaarheid kunnen worden afgeleid uit interne technische walkthroughs en loganalyse binnen de afgebakende PoC-scope. Ten slotte wordt uitgewerkt welke technische en organisatorische stappen nodig zijn om de PoC verder te ontwikkelen richting een duurzame HOGENT XR Academy.

Accreditatievraagstukken zoals CME-credits vallen in deze iteratie buiten de empirische onderzoeksuitvoering en worden daarom behandeld als toekomstig werk.
...
In Hoofdstuk~\ref{ch:ontwikkeling} wordt de implementatie van de PoC beschreven, met aandacht voor de gebruikte technologieën, de realisatie van de simulatie en de verwerking van gebruikersdata.

In Hoofdstuk~\ref{ch:evaluatie} worden de resultaten van de evaluatie en validatie besproken, op basis van interne technische walkthroughs en analyse van de gelogde data binnen de afgebakende scenescope.
