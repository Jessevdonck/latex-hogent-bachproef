...
Samengevat kan gezegd worden dat XR bijzonder effectief is voor het trainen van procedurele vaardigheden en beslissingslogica in medische contexten. Voor de ontwikkeling van volledige psychomotorische competentie blijft echter een combinatie met fysieke simulatie noodzakelijk. Deze inzichten zijn direct relevant voor de ontwikkeling van de XR-PoC in deze bachelorproef, waarin de nadruk ligt op procedurele correctheid en besluitvorming binnen BLS-training.
...
duidelijke leerdoelen en een goede afstemming met het curriculum, voldoende interactiviteit en controle voor de gebruiker, realistische maar didactisch doordachte scenario’s en ingebouwde feedbackmechanismen.
...
de juiste volgorde van handelingen duidelijk weergeven, belangrijke beslissingsmomenten zichtbaar maken, feedback geven op timing zoals tijd tot eerste compressie, en realistisch zijn zonder onnodige complexiteit.
...
Samengevat biedt XR duidelijke didactische voordelen, maar kan het traditionele leermethoden niet volledig vervangen. De literatuur wijst eerder op een hybride aanpak, waarbij XR wordt gecombineerd met fysieke simulatie en klassikale begeleiding. Deze inzichten vormen ook een belangrijk uitgangspunt voor de ontwikkeling van de XR-PoC in deze bachelorproef, waarin bewust gekozen wordt om te focussen op de procedurele en cognitieve aspecten van BLS-training, als aanvulling op bestaande praktijklessen.
...
Voor een optimale impact dient XR echter geïntegreerd te worden in een didactisch onderbouwd leertraject en gecombineerd te worden met fysieke simulatie waar tactiele vaardigheden vereist zijn. Deze inzichten vormen de basis voor het ontwerp van de XR-PoC in deze bachelorproef.