...
% uitgewerkt (eventueel met een mede-auteur).
% 
...
hoe een XR-toepassing op Meta Quest 3 realistische medische simulaties kan ondersteunen die voldoen aan didactische vereisten voor verpleegkunde, wat de minimale technische en gebruiksvoorwaarden zijn voor een schaalbare en uitbreidbare XR-simulatieomgeving, in welke mate gebruikers de XR-ervaring als realistisch, nuttig en gebruiksvriendelijk ervaren, welke kwaliteitscriteria gelden voor CME-credits en in welke mate de PoC hiervoor kwantitatieve data kan leveren, en welke technische en organisatorische stappen nodig zijn om de PoC door te ontwikkelen naar een duurzame 'HOGENT XR Academy'.
